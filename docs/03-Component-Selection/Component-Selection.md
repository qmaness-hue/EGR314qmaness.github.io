...
### Summary of Selected Major Components

| **Component**                                                                                                                                                                                      | **Rationale**                                                                                                                                    | **Later Notes**                                                                                            |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| ![](LM2575.png)<br> LM2575 Voltage Regulator<br>$2.16/each<br>[link to product](https://www.digikey.com/en/products/detail/onsemi/LM2575D2T-3-3R4G/1476688)                 | \* Perfectly adequate regulator that the class already has experience using. | \*Requires a 100uH inductor for 5 volts |
| ![](324.png)<br> 324 Stepper Motor <br>$14.00/each<br>[link to product](https://www.digikey.com/en/products/detail/adafruit-industries-llc/324/5022791)                 | \* Simple motor capable of maintaining a high torque with easily optimized accuracy                                              | \* Requires a minimum of 12 volts to function, with 9 volts allowing for only subtle movement|
| ![](TMC2209.png)<br> TMC2209 Surface Mount Motor Driver<br>$5.20/each<br>[link to product](https://www.digikey.com/en/products/detail/analog-devices-inc-maxim-integrated/TMC2209-LA-T/10232491)                 | \* Works with both the microcontoller and stepper motors chosen | \* N/A |
